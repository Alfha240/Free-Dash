...
**Method 3: One-Command (May have encoding issues)**
```bash
curl -fsSL https://raw.githubusercontent.com/Alfha240/Free-Dash/main/install.sh | bash
```

> **Note:** If you get errors with Method 3, use Method 1 or 2. See [QUICK_INSTALL.md](./QUICK_INSTALL.md) for troubleshooting.
